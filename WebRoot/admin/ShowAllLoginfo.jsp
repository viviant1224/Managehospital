...
if(pageBean!=null) {
loginfo = (List<Loginfo>)pageBean.getList();
} else {
loginfo = (List<Loginfo>)request.getAttribute("loginfo");
}
			...
			<div class="span12">
				<div class="box">
									<div class="box-head tabs">
										...
										<li class='active'>
					<form action="searLogSearch.action" class="navbar-form navbar-left" role="search">
			        <input type="text" name="searchLog" class="form-control" placeholder="Search">
...
<li><s:a href="showAlllogUserinfoDoc.action?pageBean.firstPage=0&pageBean.pageButton=0">首页 </s:a></li>
  	
	<s:if test="%{#request.pageBean.pageNum!=1}">
	<li><a href="showAlllogUserinfoDoc.action?pageBean.firstPage=<s:property value="pageBean.firstPage"/>&pageBean.pageButton=1">上一页  </a></li>
	</s:if>
	
	
	<s:if test="%{#request.pageBean.maxPageNum!=#request.pageBean.pageNum}">
	<li><a href="showAlllogUserinfoDoc.action?pageBean.firstPage=<s:property value="pageBean.firstPage"/>&pageBean.pageButton=2">下一页  </a></li>
	</s:if>
	
	
<li><a href="showAlllogUserinfoDoc.action?pageBean.firstPage=<s:property value="pageBean.firstPage"/>&pageBean.pageButton=3">尾 页</a></li>
