...
List<Patient> patientlist = (List<Patient>)pageBean.getList();
...
<table class="table table-responsive" width="900px" align="center">
  ...
  <td width="80px"><b><%=patientlist.get(i).getId() %></b></td>
   <td width="120px"><img src="<%=path%>/upload/<%=patientlist.get(i).getPimageFileName()%>" height="80px" width="80px" /></td>
...
<li><s:a href="showPaZhuanjia.action?pageBean.firstPage=0&pageBean.pageButton=0">首页 </s:a></li>
  	
	<s:if test="%{#request.pageBean.pageNum!=1}">
	<li><a href="showPaZhuanjia.action?pageBean.firstPage=<s:property value="pageBean.firstPage"/>&pageBean.pageButton=1">上一页  </a></li>
	</s:if>
	
	
	<s:if test="%{#request.pageBean.maxPageNum!=#request.pageBean.pageNum}">
	<li><a href="showPaZhuanjia.action?pageBean.firstPage=<s:property value="pageBean.firstPage"/>&pageBean.pageButton=2">下一页  </a></li>
	</s:if>
	
	
<li><a href="showPaZhuanjia.action?pageBean.firstPage=<s:property value="pageBean.firstPage"/>&pageBean.pageButton=3">尾 页</a></li>
