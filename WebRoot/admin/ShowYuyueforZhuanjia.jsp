			...
			<div class="span12">
				<div class="box">
									<div class="box-head tabs">
										...
										<li class='active'>
											<form action="searyuyueforZhuanjiaSearch.action" class="navbar-form navbar-left" role="search">
...
<li><s:a href="showyuyueZhuanjia.action?pageBean.firstPage=0&pageBean.pageButton=0">首页 </s:a></li>
	<s:if test="%{#request.pageBean.pageNum!=1}">
	<li><a href="showyuyueZhuanjia.action?pageBean.firstPage=<s:property value="pageBean.firstPage"/>&pageBean.pageButton=1">上一页  </a></li>
	</s:if>
	<s:if test="%{#request.pageBean.maxPageNum!=#request.pageBean.pageNum}">
	<li><a href="showyuyueZhuanjia.action?pageBean.firstPage=<s:property value="pageBean.firstPage"/>&pageBean.pageButton=2">下一页  </a></li>
	</s:if>
<li><a href="showyuyueZhuanjia.action?pageBean.firstPage=<s:property value="pageBean.firstPage"/>&pageBean.pageButton=3">尾 页</a></li>
